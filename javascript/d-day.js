...
function daySubmitInit() {
    ...
    const daySubmitBtn = document.querySelector(".day-submit__btn-col:first-child");
    const dayCancelBtn = document.querySelector(".day-submit__btn-col:last-child");
